...
import com.linkedin.dil.util.Database;
import com.linkedin.dil.keys.ExtractorKeys;
import com.linkedin.dil.keys.JdbcKeys;
...
public class JdbcReadConnectionTest extends PowerMockTestCase {
  ...
  public void testGetNext() throws UnsupportedEncodingException, SQLException, RetriableAuthenticationException {
    ...
    String unSupportedExtractor = "com.linkedin.dil.extractor.SomeExtractor";
    ...
    String supportedExtractor = "com.linkedin.dil.extractor.CsvExtractor";
