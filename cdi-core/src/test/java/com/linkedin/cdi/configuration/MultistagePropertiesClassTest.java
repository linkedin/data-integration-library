...
public class MultistagePropertiesClassTest {
  ...
  public void testJsonArrayProperties() {
    ...
    Assert.assertEquals(MSTAGE_DERIVED_FIELDS.getValidNonblankWithDefault(state), new JsonArray());
  ...
  public void testJsonObjectProperties() {
    SourceState state = new SourceState();
    Assert.assertEquals(MSTAGE_ACTIVATION_PROPERTY.getValidNonblankWithDefault(state), new JsonObject());
  ...
  public void testIntegerProperties() {
    SourceState state = new SourceState();
    Assert.assertEquals(MSTAGE_ABSTINENT_PERIOD_DAYS.getValidNonblankWithDefault(state), (Integer) 0);
    ...
    Assert.assertEquals(MSTAGE_ABSTINENT_PERIOD_DAYS.getValidNonblankWithDefault(state), (Integer) 99);
  }
